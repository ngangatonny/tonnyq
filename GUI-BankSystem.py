...
def debit_write(master,amt,accnt,name):
	...
	if(int(amt)>camt):
		...
		frec.write(str(strftime("[%Y-%m-%d] [%H:%M:%S]  ",gmtime()))+"     "+"              "+str(amti)+"              "+str(cb)+"\n")
		frec.close()
		messagebox.showinfo("Operation Successfull!!","Amount Withdrawn Successfully!!")
		master.destroy()
		return
...
def Cr_Amt(accnt,name):
	...
	l1.pack(side="top")
	e1.pack(side="top")
	b=tk.Button(creditwn,text="Deposit",relief="raised",command=lambda:crdt_write(creditwn,e1.get(),accnt,name))
	b.pack(side="top")
...
def De_Amt(accnt,name):
	...
	l1.pack(side="top")
	e1.pack(side="top")
	b=tk.Button(debitwn,text="Withdraw",relief="raised",command=lambda:debit_write(debitwn,e1.get(),accnt,name))
	b.pack(side="top")
...
def disp_tr_hist(accnt):
	...
	fr1.pack(side="top")
	l1=tk.Message(disp_wn,text="Your Transaction History:",padx=100,pady=20,width=1000,bg="white",fg="orange",relief="raised")
	l1.pack(side="top")
...
def Create():
	...
	e1=tk.Entry(crwn)
	e1.pack(side="top")
	l1=tk.Label(crwn,text="Enter Email:",relief="raised")
	l1.pack(side="top")
	e1=tk.Entry(crwn)
	e1.pack(side="top")
	l2=tk.Label(crwn,text="Enter opening amount:",relief="raised")
	l2.pack(side="top")
	e2=tk.Entry(crwn)
	e2.pack(side="top")
